...
// You will likely want to move this into a component like src/app/components/common/Header.tsx later
const Header = () => {
  return (
    <header className="p-4 md:p-6 flex justify-between items-center z-10 relative">
      <Link href="/" className="text-2xl font-bold tracking-tight text-red-600 hover:text-red-500 transition">
        WatchWave
      </Link>
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
        <div className="w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-color-neutral-800)_0%,_transparent_70%)]"></div>
      </div>
...
// Don't forget to run 'npm install lucide-react' if you haven't already for the icons!